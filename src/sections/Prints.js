...
import PrintsGif from '../assets/gifs/prints.gif';

const printServices = [
    {
        title: { en: "Marketing Materials & Collateral", es: "Materiales de Marketing y Publicidad" },
        description: {
    ...
    {
        title: { en: "Custom Merchandise & Promotional Items", es: "Mercancía Personalizada y Artículos Promocionales" },
        description: {
    ...
    {
        title: { en: "Signage & Environmental Graphics", es: "Señalización y Gráficos Ambientales" },
        description: {
    ...
    {
        title: { en: "Publication & Book Design", es: "Diseño de Publicaciones y Libros" },
        description: {
    ...
    {
        title: { en: "Packaging & Label Design", es: "Diseño de Empaques y Etiquetas" },
        description: {
