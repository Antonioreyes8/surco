...
import BillboardGif from '../assets/gifs/billboard.gif';

const DesignServices = [
    {
        title: { en: "Brand Identity & Logo Design", es: "Identidad de Marca y Diseño de Logotipo" },
        description: {
    ...
    {
        title: { en: "Social Media Design & Templates", es: "Diseño y Plantillas para Redes Sociales" },
        description: {
    ...
    {
        title: { en: "Print Design & Marketing Materials", es: "Diseño Impreso y Materiales de Marketing" },
        description: {
    ...
    {
        title: { en: "UI/UX Design & Prototyping", es: "Diseño UI/UX y Prototipado" },
        description: {
    ...
    {
        title: { en: "Packaging & Product Design", es: "Diseño de Empaques y Productos" },
        description: {
    ...
    {
        title: { en: "Presentation & Document Design", es: "Diseño de Presentaciones y Documentos" },
        description: {
