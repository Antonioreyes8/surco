...
import Dreambuilt from "../assets/gifs/dreambuilt.gif";
import Momos from "../assets/gifs/momos.gif";
import Cowboy from "../assets/gifs/cowboy.gif";
import WordFlashEn from "../assets/gifs/wordflashen.gif";
import WordFlashEs from "../assets/gifs/wordflashes.gif";
import Party from "../assets/gifs/party.gif";
import Vela from "../assets/gifs/vela.gif";
import GoldenRatio from "../assets/gifs/goldenratio.gif";
				...
				<div className="about-row">
					...
					<div className="about-icons">
						<div className="about-square-icon">
							<img src={Dreambuilt} alt="Dreambuilt website animation" />
						</div>
						<div className="about-square-icon">
							<img src={Momos} alt="Momos website animation" />
						</div>
					</div>
				</div>
				...
				<div className="about-row">
					...
					<div className="about-icons">
						<div className="about-circle-icon">
							<img src={Cowboy} alt="Cowboy animation" />
						</div>
						<div className="about-circle-icon">
							<img src={GoldenRatio} alt="Golden Ratio animation" />
						</div>
						<div className="about-circle-icon">
							<img src={Vela} alt="Vela animation" />
						</div>
					</div>
				</div>
				...
				<div className="about-row">
					<span className="about-header">
						...
						<div className="about-square-icon-wordflash">
							<img
								src={language === "es" ? WordFlashEs : WordFlashEn}
								alt="Word Flash"
								lang={language}
							/>
						</div>
