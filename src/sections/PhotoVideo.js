...
import PhotoCamera from "../assets/gifs/cam.gif";

const mediaServices = [
    {
        title: { en: "Promotional & Explainer Videos", es: "Videos Promocionales y Explicativos" },
        description: {
    ...
    {
        title: { en: "Social Media Video Content", es: "Contenido de Video para Redes Sociales" },
        description: {
    ...
    {
        title: { en: "Video Editing & Post-Production", es: "Edición de Video y Postproducción" },
        description: {
    ...
    {
        title: { en: "Commercial & Product Photography", es: "Fotografía Comercial y de Producto" },
        description: {
    ...
    {
        title: { en: "Photo Editing & Retouching", es: "Edición y Retoque Fotográfico" },
        description: {
    ...
    return (
        <section id="PhotoVideoSection" className="section">
            ...
            <div className="section-words">
                <h2>{lang === "es" ? "Servicios de Foto/Video" : "Photo/Video Services"}</h2>
